  ...
  try {
...

    {
      ...
      "care": {
        ...
        "water": "Watering needs and frequency",
        "soil": "Soil type and pH preferences"
      },
      "facts": ["Interesting fact 1", "Interesting fact 2", "Interesting fact 3"]
    }
    
    Ensure the response is in valid JSON format and all fields are filled with accurate information.`;
    ...
    if (!jsonMatch) {
      throw new Error("Could not extract plant information from the response");
    }
